...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆◆◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\    
 ...
 if(!message.member.roles.cache.get(ayarlar.MuteYetkilisi) && !message.member.hasPermission('741973537669251163')) return message.channel.send('Bu komuta erişim Yetkiniz yoktur. <a:carpi222:795469156245700639>')

  let kişi = message.guild.member(message.mentions.users.first() || message.guild.members.cache.get(args[0]));
  if(!kişi) return message.channel.send(`Mute atmam kişiyi belirtir misin? <a:party_blob:790180851119292417>`);
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆◆◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\    
...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆◆◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\    
    ...
    if (!muted) { message.channel.send(`Mute atmam kişiyi belirtir misin? <a:party_blob:790180851119292417>`);
   } else {
      if (muted.roles.highest.position >= message.member.roles.highest.position) 
      {
        ...
        let mutezaman = args[1]
          ...
          .replace("gün", "d");
        if (!mutezaman) {
          message.reply("bir zaman girmediniz! <a:dnyor2:795468242998394910>");
        } else {
          let sebep = args[2]
          if(!args[2]) return message.channel.send(`Son olarak bir sebep belirt misin? <a:party_blob:790180851119292417>`)
