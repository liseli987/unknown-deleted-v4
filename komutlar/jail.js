...
if(!message.member.roles.cache.has(ayarlar.JailYetkilisi) && !message.member.hasPermission('ADMINISTRATOR')) return message.channel.send('Bu komuta erişim Yetkiniz yoktur. <a:carpi222:795469156245700639>')
  
  const kişi = message.guild.member(message.mentions.members.first() || message.guild.members.cache.get(args[0]));
  if(!kişi) return message.channel.send('Jaile atmam gereken kişiyi belirtir misin? <a:party_blob:790180851119292417>')
...
//━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━◆◆◆━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\\  
  ...
  let zaman = args[1]
  if(!args[1]) return message.channel.send('Ne kadar süre duracağını belirt <a:party_blob:790180851119292417>')

let sebep = args.join(``).slice(args[1].length+args[0].length)
if(!sebep) return message.channel.send('Bir sebep belirtir misin ? <a:party_blob:790180851119292417>')
