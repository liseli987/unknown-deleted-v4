...
exports.run = async(client, message, args) => {    
 if(!message.member.roles.cache.some(r => ["709069702659309568", "ROL ID"].includes(r.id))) //
    return message.reply("Bu komuta erişim Yetkiniz yoktur. <a:carpi222:795469156245700639>")
  //------------------------------------------------KAYITLAR-----------------------------------------------\\    STG   
